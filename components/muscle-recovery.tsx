...
const masculineRegions:Region[]=[
 ...
 {group:'Rear Delts',d:'M365 181 C350 184 343 199 346 216 C348 229 355 238 366 238 C374 224 379 203 375 189 C372 184 369 182 365 181Z'},{group:'Rear Delts',d:'M551 181 C566 184 573 199 570 216 C568 229 561 238 550 238 C542 224 537 203 541 189 C544 184 547 182 551 181Z'},
 {group:'Traps',d:'M414 145 C425 160 441 171 456 178 L456 221 C438 212 420 200 405 184 C409 171 412 157 414 145Z'},{group:'Traps',d:'M460 178 C475 171 491 160 502 145 C504 157 507 171 511 184 C496 200 478 212 460 221Z'},
 ...
 {group:'Triceps',d:'M352 229 C344 250 345 286 353 318 C357 332 363 339 369 336 C378 315 383 278 378 247 C375 232 365 223 357 225 C355 226 353 227 352 229Z'},{group:'Triceps',d:'M564 229 C572 250 571 286 563 318 C559 332 553 339 547 336 C538 315 533 278 538 247 C541 232 551 223 559 225 C561 226 563 227 564 229Z'},
 ...
 {group:'Forearms',d:'M351 326 C344 346 340 375 341 404 C342 426 348 445 356 451 C363 437 367 411 367 384 C367 356 361 334 351 326Z'},{group:'Forearms',d:'M565 326 C572 346 576 375 575 404 C574 426 568 445 560 451 C553 437 549 411 549 384 C549 356 555 334 565 326Z'},
 {group:'Upper Back',d:'M386 218 C404 222 433 237 456 258 L456 334 C430 317 405 288 386 252 C381 240 381 229 386 218Z'},{group:'Upper Back',d:'M460 258 C483 237 512 222 530 218 C535 229 535 240 530 252 C511 288 486 317 460 334Z'},
 {group:'Lower Back',d:'M421 311 C432 326 444 338 456 345 L456 405 C438 391 424 359 421 311Z'},{group:'Lower Back',d:'M460 345 C472 338 484 326 495 311 C492 359 478 391 460 405Z'},
 ...
 {group:'Glutes',d:'M388 406 C408 389 438 392 456 418 L456 481 C432 495 402 486 389 463 C381 448 381 423 388 406Z'},{group:'Glutes',d:'M460 418 C478 392 508 389 528 406 C535 423 535 448 527 463 C514 486 484 495 460 481Z'},
 ...
 {group:'Hamstrings',d:'M395 492 C416 484 440 498 451 531 C449 584 435 631 413 660 C397 643 388 596 387 548 C387 524 389 505 395 492Z'},{group:'Hamstrings',d:'M465 531 C476 498 500 484 521 492 C527 505 529 524 529 548 C528 596 519 643 503 660 C481 631 467 584 465 531Z'},
 ...
 {group:'Calves',d:'M399 657 C414 647 429 665 431 696 C429 731 418 761 406 774 C395 751 388 715 390 687 C391 673 394 663 399 657Z'},{group:'Calves',d:'M485 696 C487 665 502 647 517 657 C522 663 525 673 526 687 C528 715 521 751 510 774 C498 761 487 731 485 696Z'},
];
