...
const masculineRegions:Region[]=[
 ...
 {group:'Rear Delts',d:'M363 183 C351 185 345 198 347 214 C349 225 355 233 364 235 C371 222 375 203 372 190 C370 186 367 184 363 183Z'},{group:'Rear Delts',d:'M541 183 C553 185 559 198 557 214 C555 225 549 233 540 235 C533 222 529 203 532 190 C534 186 537 184 541 183Z',transform:'translate(19 0)'},
