...
type Region={group:MuscleGroup;d:string;transform?:string};
const masculineRegions:Region[]=[
 ...
 {group:'Rear Delts',d:'M363 183 C351 185 345 198 347 214 C349 225 355 233 364 235 C371 222 375 203 372 190 C370 186 367 184 363 183Z'},{group:'Rear Delts',d:'M541 183 C553 185 559 198 557 214 C555 225 549 233 540 235 C533 222 529 203 532 190 C534 186 537 184 541 183Z',transform:'translate(14 0)'},
 {group:'Traps',d:'M418 147 C428 160 443 171 456 177 L456 231 C441 220 425 207 411 190 C413 176 416 160 418 147Z',transform:'translate(6 0)'},{group:'Traps',d:'M460 177 C473 171 488 160 498 147 C500 160 503 176 505 190 C491 207 475 220 460 231Z',transform:'translate(6 0)'},
 ...
 {group:'Triceps',d:'M354 230 C348 250 349 282 356 313 C359 327 364 335 369 334 C376 313 380 279 376 250 C374 236 366 227 359 227 C357 227 355 228 354 230Z',transform:'translate(365 280) scale(1.18 1.08) translate(-365 -280)'},{group:'Triceps',d:'M550 230 C556 250 555 282 548 313 C545 327 540 335 535 334 C528 313 524 279 528 250 C530 236 538 227 545 227 C547 227 549 228 550 230Z',transform:'translate(26 0) translate(540 280) scale(1.18 1.08) translate(-540 -280)'},
 ...
 {group:'Forearms',d:'M350 326 C343 347 339 375 340 403 C341 426 347 445 356 451 C362 437 365 412 365 385 C365 357 360 335 350 326Z'},{group:'Forearms',d:'M557 326 C565 346 570 375 571 403 C572 426 567 445 559 451 C551 437 547 412 547 385 C547 357 550 335 557 326Z',transform:'translate(25 0)'},
 {group:'Upper Back',d:'M390 222 C407 226 434 244 454 267 L454 340 C431 322 409 294 392 262 C386 248 385 234 390 222Z',transform:'translate(6 0)'},{group:'Upper Back',d:'M462 267 C482 244 509 226 526 222 C531 234 530 248 524 262 C507 294 485 322 462 340Z',transform:'translate(6 0)'},
 {group:'Lower Back',d:'M428 318 C437 330 446 341 454 347 L454 402 C441 388 431 358 428 318Z',transform:'translate(6 0)'},{group:'Lower Back',d:'M462 347 C470 341 479 330 488 318 C485 358 475 388 462 402Z',transform:'translate(6 0)'},
 ...
 {group:'Glutes',d:'M389 407 C407 393 436 393 454 418 L454 479 C433 492 407 485 394 465 C385 450 383 424 389 407Z'},{group:'Glutes',d:'M465 418 C483 393 512 393 530 407 C536 424 534 450 525 465 C512 485 486 492 465 479Z',transform:'translate(5 0)'},
 ...
 {group:'Hamstrings',d:'M393 491 C412 485 438 500 449 533 C447 584 434 630 413 657 C398 636 390 594 389 550 C389 525 390 505 393 491Z'},{group:'Hamstrings',d:'M477 533 C488 500 514 485 533 491 C536 505 537 525 537 550 C536 594 528 636 513 657 C492 630 479 584 477 533Z',transform:'translate(7 0)'},
 ...
 {group:'Calves',d:'M401 658 C414 650 428 667 430 696 C428 729 418 758 406 772 C396 747 391 715 392 688 C393 674 396 664 401 658Z'},{group:'Calves',d:'M496 696 C498 667 512 650 525 658 C530 664 533 674 534 688 C535 715 530 747 520 772 C508 758 498 729 496 696Z',transform:'translate(9 0)'},
];
