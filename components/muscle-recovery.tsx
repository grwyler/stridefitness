...
const masculineRegions:Region[]=[
 ...
 {group:'Triceps',d:'M354 230 C348 250 349 282 356 313 C359 327 364 335 369 334 C376 313 380 279 376 250 C374 236 366 227 359 227 C357 227 355 228 354 230Z'},{group:'Triceps',d:'M550 230 C556 250 555 282 548 313 C545 327 540 335 535 334 C528 313 524 279 528 250 C530 236 538 227 545 227 C547 227 549 228 550 230Z',transform:'translate(21 0)'},
