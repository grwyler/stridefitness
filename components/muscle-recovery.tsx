...
const masculineRegions:Region[]=[
 ...
 {group:'Rear Delts',d:'M363 183 C351 185 345 198 347 214 C349 225 355 233 364 235 C371 222 375 203 372 190 C370 186 367 184 363 183Z'},{group:'Rear Delts',d:'M541 183 C553 185 559 198 557 214 C555 225 549 233 540 235 C533 222 529 203 532 190 C534 186 537 184 541 183Z',transform:'translate(8 0)'},
 ...
 {group:'Triceps',d:'M354 230 C348 250 349 282 356 313 C359 327 364 335 369 334 C376 313 380 279 376 250 C374 236 366 227 359 227 C357 227 355 228 354 230Z'},{group:'Triceps',d:'M550 230 C556 250 555 282 548 313 C545 327 540 335 535 334 C528 313 524 279 528 250 C530 236 538 227 545 227 C547 227 549 228 550 230Z',transform:'translate(14 0)'},
 ...
 {group:'Forearms',d:'M350 326 C343 347 339 375 340 403 C341 426 347 445 356 451 C362 437 365 412 365 385 C365 357 360 335 350 326Z'},{group:'Forearms',d:'M557 326 C565 346 570 375 571 403 C572 426 567 445 559 451 C551 437 547 412 547 385 C547 357 550 335 557 326Z',transform:'translate(20 0)'},
