...
export type Nutrition={entries:FoodLog[];calorieTarget:number|null;proteinTarget:number|null;carbTarget?:number|null;fatTarget?:number|null;activityCalorieAdjustment?:ActivityCalorieAdjustment};
export const emptyNutrition=():Nutrition=>({entries:[],calorieTarget:null,proteinTarget:null,carbTarget:null,fatTarget:null,activityCalorieAdjustment:0});
